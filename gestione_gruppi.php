    ...
    <div class="container">
        ...
        <div class="btn-row">
            ...
            <div style="display: flex; gap: 10px;">
                <!-- Nuovo pulsante per gestione manuale con percorso corretto -->
                <a href="gestione_gruppi_manuale.php?evento=<?php echo $evento_id; ?>" class="btn btn-success">
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <p>Puoi creare i gruppi automaticamente o utilizzare la gestione manuale per crearli uno ad uno.</p>
            </div>
        <?php endif; ?>
    </div>
</body>
