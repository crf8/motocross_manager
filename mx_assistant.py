...
class MXAssistant(QDialog):
    ...
    def setup_ui(self):
        ...
        self.setup_tutorials_tab()  # Aggiungi la nuova scheda tutorial
    ...
    def load_knowledge_base(self):
        ...
        # In una versione reale, caricheresti da un file JSON o un database
        # Qui uso un esempio integrato con articoli per tutte le funzionalità
        return [
            # GUIDA INTRODUTTIVA
            {
