...
class PilotaDialog(QDialog):
    def __init__(self, parent=None, pilota_id=None):
        ...
        # Nel metodo __init__ della classe MainWindow
...
class PilotiTab(QWidget):
    def __init__(self):
        ...
        self.btn_statistiche = QPushButton("Visualizza Statistiche")
        self.btn_statistiche.clicked.connect(self.view_pilot_statistics)
        ...
        button_layout = QHBoxLayout()  # o come si chiama il tuo layout
        button_layout.addWidget(self.add_button)
        button_layout.addWidget(self.edit_button)
        button_layout.addWidget(self.delete_button)
        button_layout.addWidget(self.btn_statistiche)
